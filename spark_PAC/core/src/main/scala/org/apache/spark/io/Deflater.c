...
Java_org_apache_spark_io_KaeDeflater_initIDs(JNIEnv *env, jclass cls)
{
...
Java_org_apache_spark_io_KaeDeflater_init(JNIEnv *env, jclass cls, jint level,
...
JNIEXPORT void JNICALL
Java_org_apache_spark_io_KaeDeflater_setDictionary(JNIEnv *env, jclass cls, jlong addr,
...
Java_org_apache_spark_io_KaeDeflater_deflateBytes(JNIEnv *env, jobject this, jlong addr,
...
JNIEXPORT jint JNICALL
Java_org_apache_spark_io_KaeDeflater_getAdler(JNIEnv *env, jclass cls, jlong addr)
{
    return ((z_stream *)jlong_to_ptr(addr))->adler;
}

JNIEXPORT void JNICALL
Java_org_apache_spark_io_KaeDeflater_reset(JNIEnv *env, jclass cls, jlong addr)
{
...
JNIEXPORT void JNICALL
Java_org_apache_spark_io_KaeDeflater_end(JNIEnv *env, jclass cls, jlong addr)
{
