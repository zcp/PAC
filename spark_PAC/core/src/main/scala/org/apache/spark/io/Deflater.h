...
#ifndef _Included_Deflater
#define _Included_Deflater
#ifdef __cplusplus
extern "C" {
#endif
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_org_apache_spark_io_KaeDeflater_initIDs
  (JNIEnv *, jclass);
 ...
 * Signature: (IIZ)J
 */
JNIEXPORT jlong JNICALL Java_org_apache_spark_io_KaeDeflater_init
 ...
 * Signature: (J[BII)V
 */
JNIEXPORT void JNICALL Java_org_apache_spark_io_KaeDeflater_setDictionary
 ...
 * Signature: (J[BIII)I
 */
JNIEXPORT jint JNICALL Java_org_apache_spark_io_KaeDeflater_deflateBytes
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_org_apache_spark_io_KaeDeflater_getAdler
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_apache_spark_io_KaeDeflater_reset
  (JNIEnv *, jclass, jlong);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_apache_spark_io_KaeDeflater_end
  (JNIEnv *, jclass, jlong);
