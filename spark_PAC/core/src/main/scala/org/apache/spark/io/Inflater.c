...
Java_org_apache_spark_io_KaeInflater_initIDs(JNIEnv *env, jclass cls)
{
...
Java_org_apache_spark_io_KaeInflater_init(JNIEnv *env, jclass cls, jboolean nowrap)
{
...
JNIEXPORT void JNICALL
Java_org_apache_spark_io_KaeInflater_setDictionary(JNIEnv *env, jclass cls, jlong addr,
...
Java_org_apache_spark_io_KaeInflater_inflateBytes(JNIEnv *env, jobject this, jlong addr,
                                         jarray b, jint off, jint len)
{
...
JNIEXPORT jint JNICALL
Java_org_apache_spark_io_KaeInflater_getAdler(JNIEnv *env, jclass cls, jlong addr)
{
    return ((z_stream *)jlong_to_ptr(addr))->adler;
}

JNIEXPORT void JNICALL
Java_org_apache_spark_io_KaeInflater_reset(JNIEnv *env, jclass cls, jlong addr)
{
...
JNIEXPORT void JNICALL
Java_org_apache_spark_io_KaeInflater_end(JNIEnv *env, jclass cls, jlong addr)
{
