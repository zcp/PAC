...
Java_ZipFile_initIDs(JNIEnv *env, jclass cls)
{
...
Java_ZipFile_open(JNIEnv *env, jclass cls, jstring name,
...
Java_ZipFile_getTotal(JNIEnv *env, jclass cls, jlong zfile)
{
...
Java_ZipFile_startsWithLOC(JNIEnv *env, jclass cls, jlong zfile)
{
    jzfile *zip = jlong_to_ptr(zfile);
...
JNIEXPORT void JNICALL
Java_ZipFile_close(JNIEnv *env, jclass cls, jlong zfile)
{
    ZIP_Close(jlong_to_ptr(zfile));
}

JNIEXPORT jlong JNICALL
Java_ZipFile_getEntry(JNIEnv *env, jclass cls, jlong zfile,
...
JNIEXPORT void JNICALL
Java_ZipFile_freeEntry(JNIEnv *env, jclass cls, jlong zfile,
                                    jlong zentry)
{
    jzfile *zip = jlong_to_ptr(zfile);
...
JNIEXPORT jlong JNICALL
Java_ZipFile_getNextEntry(JNIEnv *env, jclass cls, jlong zfile,
                                        jint n)
{
...
JNIEXPORT jint JNICALL
Java_ZipFile_getEntryMethod(JNIEnv *env, jclass cls, jlong zentry)
{
    jzentry *ze = jlong_to_ptr(zentry);
...
JNIEXPORT jint JNICALL
Java_ZipFile_getEntryFlag(JNIEnv *env, jclass cls, jlong zentry)
{
    jzentry *ze = jlong_to_ptr(zentry);
    return ze->flag;
}
...
JNIEXPORT jlong JNICALL
Java_ZipFile_getEntryCSize(JNIEnv *env, jclass cls, jlong zentry)
{
    jzentry *ze = jlong_to_ptr(zentry);
...
JNIEXPORT jlong JNICALL
Java_ZipFile_getEntrySize(JNIEnv *env, jclass cls, jlong zentry)
{
    jzentry *ze = jlong_to_ptr(zentry);
    return ze->size;
}
...
JNIEXPORT jlong JNICALL
Java_ZipFile_getEntryTime(JNIEnv *env, jclass cls, jlong zentry)
{
    jzentry *ze = jlong_to_ptr(zentry);
...
JNIEXPORT jlong JNICALL
Java_ZipFile_getEntryCrc(JNIEnv *env, jclass cls, jlong zentry)
{
    jzentry *ze = jlong_to_ptr(zentry);
...
Java_ZipFile_getCommentBytes(JNIEnv *env,
                                           jclass cls,
                                           jlong zfile)
{
    jzfile *zip = jlong_to_ptr(zfile);
...
JNIEXPORT jbyteArray JNICALL
Java_ZipFile_getEntryBytes(JNIEnv *env,
                                         jclass cls,
...
JNIEXPORT jint JNICALL
Java_ZipFile_read(JNIEnv *env, jclass cls, jlong zfile,
...
Java_ZipFile_getZipMessage(JNIEnv *env, jclass cls, jlong zfile)
{
    jzfile *zip = jlong_to_ptr(zfile);
    char *msg = zip->msg;
    if (msg == NULL) {
