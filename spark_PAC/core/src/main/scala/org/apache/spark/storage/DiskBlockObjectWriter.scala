...
private[spark] class DiskBlockObjectWriter(
  ...
  override def write(key: Any, value: Any): Unit = {
    ...
    // System.out.print("zcp, DiskBokcObjectWriter:: write(pair) is called, " +
    //                 "key,value," + key.asInstanceOf[String].size + "," + value + "\n")
    recordWritten()
  }
  ...
  override def write(kvBytes: Array[Byte], offs: Int, len: Int): Unit = {
    ...
    // System.out.print("zcp, DiskBokcObjectWriter:: write(Array[Byte) is called \n")
