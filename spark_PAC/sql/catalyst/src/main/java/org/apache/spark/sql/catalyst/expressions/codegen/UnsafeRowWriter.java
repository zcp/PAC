...
public final class UnsafeRowWriter extends UnsafeWriter {
  ...
  final Logger logger = LoggerFactory.getLogger(UnsafeRowWriter.class);
  ...
  private UnsafeRowWriter(UnsafeRow row, BufferHolder holder, int numFields) {
    ...
    //logger.info("zcp, UnsafeRowWriter::Constructor is called. numFields,row," + numFields + "," + row);
  }
  ...
  public void write(int ordinal, boolean value) {
    ...
    //logger.info("zcp, UnsafeRowWriter::write(boolean) is called.");
  }
  ...
  public void write(int ordinal, byte value) {
    ...
    //logger.info("zcp, UnsafeRowWriter::write(byte) is called.");
  }
  ...
  public void write(int ordinal, short value) {
    ...
    //logger.info("zcp, UnsafeRowWriter::write(short) is called.");
  }
  ...
  public void write(int ordinal, int value) {
    ...
    //logger.info("zcp, UnsafeRowWriter::write(int) is called.");
  }
  ...
  public void write(int ordinal, float value) {
    ...
    //logger.info("zcp, UnsafeRowWriter::write(float) is called.");
  }
  ...
  public void write(int ordinal, Decimal input, int precision, int scale) {
    //logger.info("zcp, UnsafeRowWriter::write(decimal and precision) is called.");
